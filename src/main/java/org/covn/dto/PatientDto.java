...
public class PatientDto extends UserDto {
    ...
    public void setHighRiskHealthcareWorker(boolean highRiskHealthcareWorker) {
        isHighRiskHealthcareWorker = highRiskHealthcareWorker;
    }
    ...
    public String toString() {
        return "PatientDto{" +
                ...
                ", hasInterationalTravel=" + hasInterationalTravel +
                ", hasInterstateTravel=" + hasInterstateTravel +
                ", hasHighRiskFacilityVisit=" + hasHighRiskFacilityVisit +
                ", isHighRiskHealthcareWorker=" + isHighRiskHealthcareWorker +
