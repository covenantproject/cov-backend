...
public abstract class PreExistingConditionCovidDenorm_ {
	...
	public static final String CHRONIC_RENAL_DISEASE = "chronicRenalDisease";
	public static final String PRE_EXISTING_CONDITION_ID = "preExistingConditionId";
	public static final String COVID_PRE_EXISTING_CONDITION_ID = "covidPreExistingConditionId";
	public static final String DIABETES_MELLITUS = "diabetesMellitus";
